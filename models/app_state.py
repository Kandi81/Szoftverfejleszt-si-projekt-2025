...
class AppState:
    ...
    email_data_map: Dict[str, Dict] = field(default_factory=dict)
    all_tree_items: List[str] = field(default_factory=list)
    ...
    gmail_service: Optional[object] = None  # ← ADDED from branch1
